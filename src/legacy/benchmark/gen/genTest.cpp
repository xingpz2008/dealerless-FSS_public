...
int main(int argc, char **argv){
    ...
    DPFKeyPack EQ_key;
    LegacyComparisonKeyPack CMP_key;
    ...
    switch (function_choice) {
        ...
        case 3:{
            CMP_key = dfss::legacy::legacyComparisonOffline(party, Bin, Bout, GroupElement(1, Bin), &payload, true);
            break;
        }
        default:{
    ...
    switch (function_choice) {
        ...
        case 3:{
            dfss::legacy::legacyComparison(party, res, &x, &CMP_key, 1, Bin);
            break;
        }
        default:{
            std::cout << "[ERROR] No matching function!" << std::endl;
