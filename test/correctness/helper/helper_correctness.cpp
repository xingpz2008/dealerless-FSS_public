...
// Command-line entry point and registry for helper-only correctness cases.
...
const CorrectnessCase kCorrectnessCases[] = {
    {1, "constrained comparison", check_constrained_comparison},
    {2, "Boolean wrappers", check_boolean_wrappers},
    {3, "OHG", check_ohg},
};
